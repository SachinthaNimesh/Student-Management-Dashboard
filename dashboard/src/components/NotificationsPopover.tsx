...
export const NotificationsPopover = () => {
  ...
  return (
    <Popover>
      ...
      <PopoverContent className="w-80 bg-white p-0 shadow-lg rounded-lg" align="end">
        ...
        <div className="max-h-[400px] overflow-y-auto">
          {notifications.map((notification) => (
            <div key={notification.id} className="p-4 border-b border-gray-100">
              ...
              <div className="mb-3">
                <p className="text-sm text-gray-600">Student ID: {notification.studentId}</p>
                <p className="text-sm text-gray-600">Student Name: {notification.studentName}</p>
              </div>
